...
function setComprasDocumentacionArticle(){
  const html =  `
...
function showComprasDocumentacionArticle(){
  document.getElementById('compras_documentacion_article').classList.remove('d-none')
}

function hideComprasDocumentacionArticle(){
  document.getElementById('compras_documentacion_article').classList.add('d-none')
}
